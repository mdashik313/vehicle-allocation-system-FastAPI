<h1> A simple vehicle allocation system for employees of a company using FastAPI and MongoDB. Features : create allocation, view allocations, delete allocation, update allocation, search allocations with multiple filter. </h1>
